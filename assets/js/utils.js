var Utils = {
    ...
    apiCall: function (method, url, parameters, config) {
        ...
        call_config.url = url
        method.toUpperCase()=="GET" ? call_config.params = parameters : call_config.data=parameters
        ...
        //             tmp.append(keys[i],parameters[keys[i]])
        //         }
        //         call_config.data=tmp
        //         call_config.headers['Content-type:application/x-www-form-urlencoded']
        //     }
        // }
